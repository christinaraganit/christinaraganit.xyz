            ...
            <div className={`${maxW} w-full flex flex-col gap-8 md:gap-0 md:flex-row justify-between items-center`}>
                <div className="flex flex-col text-center md:text-left">
                    ...
                    <div className="flex gap-2 w-full items-center">
                        <img src="/favicon-pixel.png" className="w-5.5 h-5.5" />
                ...
                <div className='flex items-center gap-5.5 ml-3 md:ml-0 order-first md:order-last'>
                    <a className='cursor-gauntlet -mt-0.5' href='https://x.com/christinargnt'>
                    ...
                    <a className='cursor-gauntlet' href='https://github.com/christinaraganit/'>
                    ...
                    <a className='cursor-gauntlet' href='https://www.linkedin.com/in/christinaraganit/'>
                    ...
                    <a className='cursor-gauntlet' href='https://devpost.com/christinaraganit'>
